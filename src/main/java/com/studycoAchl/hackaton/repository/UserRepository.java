...
@Repository
public interface UserRepository extends JpaRepository<app_users, UUID> {
    ...
    // 닉네임 중복 체크용
    Optional<app_users> findByNickname(String nickname);
    boolean existsByNickname(String nickname);

    // 인증용
    Optional<app_users> findByToken(String token);
}